...
Callback функция нужна для обработки входящий сообщений, она должна быть типа String и то, что она вернёт будет отправлено
как ответ в тот-же чат, из которого пришёл запрос. Логика в том, что на любой запрос бот обязан ответить.